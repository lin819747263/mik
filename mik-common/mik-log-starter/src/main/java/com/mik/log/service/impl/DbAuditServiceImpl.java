package com.mik.log.service.impl;

import com.mik.log.model.Audit;
import com.mik.log.properties.LogDbProperties;
import com.mik.log.service.IAuditService;
...
@Slf4j
@Service
@ConditionalOnProperty(name = "mik.audit-log.log-type", havingValue = "db")
