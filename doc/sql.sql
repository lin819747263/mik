...
-- ----------------------------
-- Table structure for nav_card
-- ----------------------------
DROP TABLE IF EXISTS `nav_card`;
CREATE TABLE `nav_card`  (
  `id` int NOT NULL,
...
-- ----------------------------
-- Table structure for top_bar
-- ----------------------------
DROP TABLE IF EXISTS `top_bar`;
